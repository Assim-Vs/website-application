"""
Django settings for vasthramalika project.
...
ROOT_URLCONF = 'vasthramalika.urls'
...
WSGI_APPLICATION = 'vasthramalika.wsgi.application'
...
# Email Configuration for Password Reset (Console for development)
